...
To build the documentation locally, use uv to manage dependencies:
...
**Note:** This project requires Python 3.9+ and uses dependency groups (PEP 735) for managing optional dependencies.
